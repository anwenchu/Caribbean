...
import com.anwenchu.caribbean.channel.huobi.signature.ApiSignatureV2;
...
import com.anwenchu.caribbean.utils.IdGenerator;
import com.anwenchu.caribbean.utils.InternalUtils;
import com.anwenchu.caribbean.utils.WebSocketWatchDog;
import lombok.Data;
...
public class HuobiWebSocketConnection extends WebSocketListener implements WebSocketConnection {
    ...
    public static HuobiWebSocketConnection createAssetConnection(HuoBiArbitrageConfig options,
    ...
    public static HuobiWebSocketConnection createAssetV2Connection(HuoBiArbitrageConfig options,
                                                                   List<String> commandList,
                                                                   HuobiModelParser parser,
                                                                   ResponseCallback callback,
                                                                   Boolean autoClose) {
    ...
    public static HuobiWebSocketConnection createMarketConnection(HuoBiArbitrageConfig options,
                                                                  List<String> commandList,
                                                                  HuobiModelParser parser,
                                                                  ResponseCallback callback,
                                                                  boolean autoClose) {
    ...
    public static HuobiWebSocketConnection createConnection(HuoBiArbitrageConfig options,
                                                            List<String> commandList,
                                                            HuobiModelParser parser,
                                                            ResponseCallback callback,
                                                            Boolean autoClose,
